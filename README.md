...
dbname=piwigo
sudo mysql | CREATE DATABASE $dbname;

# https://freeandthings.wordpress.com/tag/piwigo/
wget --keep-session-cookies --save-cookies cookies.txt --delete-after --post-data="username=admin&password=admin&method=pwg.session.login" "https://127.0.0.1:8001/ws.php"
