...
class ArticleReferenceAdminController extends BaseController
{
     ...
     */
    #[Route(path: '/admin/article/{id}/references', name: 'admin_article_add_reference', methods: ['POST'])]
     ...
     * @IsGranted("MANAGE", subject="article")
     */
    #[Route(path: '/admin/article/{id}/references', methods: 'GET', name: 'admin_article_list_references')]
     ...
     * @IsGranted("MANAGE", subject="article")
     */
    #[Route(path: '/admin/article/{id}/references/reorder', methods: 'POST', name: 'admin_article_reorder_references')]
    ...
    #[Route(path: '/admin/article/references/{id}/download', name: 'admin_article_download_reference', methods: ['GET'])]
    ...
    #[Route(path: '/admin/article/references/{id}', name: 'admin_article_delete_reference', methods: ['DELETE'])]
    ...
    #[Route(path: '/admin/article/references/{id}', name: 'admin_article_update_reference', methods: ['PUT'])]
