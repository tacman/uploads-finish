...
class Article
{
    ...
    #[ORM\OneToMany(targetEntity: \App\Entity\Comment::class, mappedBy: 'article', fetch: 'EXTRA_LAZY')]
    ...
    #[ORM\OneToMany(targetEntity: \App\Entity\ArticleReference::class, mappedBy: 'article')]
